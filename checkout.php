        ...
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="billing-details">
                        ...
                        <form>
                            ...
                            <div class="clearfix space20"></div>
                            <input class="form-control" placeholder="Apartment, suite, unit etc. (optional)" value=""
                                type="text">
                            <div class="clearfix space20"></div>
                            <div class="row">
                                <div class="col-md-4">
            ...
            <div class="payment-method">
                <div class="row">
                    <form>
                        <div class="col-md-4">
                            <input name="payment" id="radio1" class="css-checkbox" type="radio"><span>Direct Bank
                                Transfer</span>
                ...
                <div class="space30"></div>
                <form>
                    <input name="checkboxG2" id="checkboxG2" class="css-checkbox" type="checkbox"><span>I've read and
