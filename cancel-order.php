<?php
    ...
    if(isset($_POST) & !empty($_POST)){
        ...
        $cancelsql = "INSERT INTO ordertracking (orderid, status, message) VALUES ('$id', 'cancelled', '$cancel')";
        $cancelres = mysqli_query($connection, $cancelsql) or die(mysqli_error($connection));
        if($cancelres){
